...
/*Guian.Chen@MULTIMEDIA.AUDIODRIVER.FEATURE.FTM, 2020/08/19, Add for Hostless*/
#include "dailink_extends.h"
#endif /* OPLUS_FEATURE_AUDIO_FTM */

//#ifdef OPLUS_ARCH_EXTENDS
#ifdef CONFIG_SND_SOC_SIA81XX
/*Kaiqin.Huang@RM.MM.AudioDriver.codec, 2020/08/04, Modify for support sia81xx codec */
...
/*Suresh.Alla@MULTIMEDIA.AUDIODRIVER.HEADSETDET.1226699, 2020/07/31,
...
static struct wcd_mbhc_config wcd_mbhc_cfg = {
	...
	.calibration = NULL,
	#ifndef OPLUS_ARCH_EXTENDS
	/* Suresh.Alla@MULTIMEDIA.AUDIODRIVER.HEADSETDET.959366, 2020/08/13,
	 * Modify for headset detect.
	 */
	...
	#ifndef OPLUS_ARCH_EXTENDS
	/*Suresh.Alla@MULTIMEDIA.AUDIODRIVER.HEADSETDET, 2020/07/31, Modify for disable moisture detect*/
...
#ifdef OPLUS_ARCH_EXTENDS
/*Chunyu.Xie@MULTIMEDIA.AUDIODRIVER.MACHINE, 2020/08/09, Add for oplus extend audio*/
...
static bool msm_usbc_swap_gnd_mic(struct snd_soc_codec *codec, bool active)
{
	...
	#ifndef OPLUS_ARCH_EXTENDS
	/*Suresh.Alla@MULTIMEDIA.AUDIODRIVER.HEADSETDET.2573181, 2020/08/13,
...
static int msm_mi2s_snd_startup(struct snd_pcm_substream *substream)
{
	...
	/*Suresh.Alla@MULTIMEDIA.AUDIODRIVER.MACHINE, 2020/08/14, Add for MI2S patch*/
...
static void *def_wcd_mbhc_cal(void)
{
	...
	#ifndef OPLUS_ARCH_EXTENDS
	/*Suresh.Alla@MULTIMEDIA.AUDIODRIVER.HEADSETDET.1226706, 2020/07/31,
...
static struct snd_soc_dai_link msm_common_misc_fe_dai_links[] = {
	...
	#ifdef OPLUS_FEATURE_AUDIO_FTM
	/* Guian.Chen@MULTIMEDIA.AUDIODRIVER.FEATURE.FTM, 2020/08/10, Add for headset mic loopback, add to the end*/
...
static struct snd_soc_dai_link msm_wsa_cdc_dma_be_dai_links[] = {
	/* WSA CDC DMA Backend DAI Links */
	{
		...
		/*Suresh.Alla@MULTIMEDIA.AUDIODRIVER.MACHINE, 2020/07/31, Delete for disable wsa*/
...
static struct snd_soc_dai_link msm_va_cdc_dma_be_dai_links[] = {
	{
		...
		/*Suresh.Alla@MULTIMEDIA.AUDIODRIVER.MACHINE, 2020/07/31,  Add for audrx init when disable wsa*/
		.init = &msm_int_audrx_init,
		#endif /* OPLUS_FEATURE_PLATFORM_ATOLL */
...
static struct snd_soc_card *populate_snd_card_dailinks(struct device *dev)
{
	...
	u32 wcn_btfm_intf = 0;
	#ifdef OPLUS_FEATURE_PLATFORM_ATOLL
	/*Suresh.Alla@MULTIMEDIA.AUDIODRIVER.MACHINE, 2020/07/31, Add for disable wsa*/
	...
	if (!strcmp(match->data, "codec")) {
		...
		#ifndef OPLUS_FEATURE_PLATFORM_ATOLL
		/*Suresh.Alla@MULTIMEDIA.AUDIODRIVER.MACHINE, 2020/07/31, Modify for disable wsa*/
		memcpy(msm_kona_dai_links + total_links,
		...
		if (rc) {
			...
			if (mi2s_audio_intf) {
				#ifdef OPLUS_ARCH_EXTENDS
				/*Chunyu.Xie@MULTIMEDIA.AUDIODRIVER.MACHINE, 2020/08/10, Add for oplus extend audio*/
...
static int msm_asoc_machine_probe(struct platform_device *pdev)
{
	...
	#ifdef OPLUS_FEATURE_PLATFORM_ATOLL
	/* Suresh.Alla@MULTIMEDIA.AUDIODRIVER.MACHINE,2020/07/31, Add for log*/
	pr_info("%s: *** Enter\n", __func__);
	#endif /* OPLUS_FEATURE_PLATFORM_ATOLL */
