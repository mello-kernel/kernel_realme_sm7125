...
/*Suresh.Alla@MULTIMEDIA.AUDIODRIVER.MACHINE, 2020/07/31, Delete for use MI2S*/
//#define CONFIG_MI2S_DISABLE 1
#endif /* OPLUS_ARCH_EXTENDS */
#define CONFIG_AUXPCM_DISABLE 1
#define CONFIG_DIGITAL_CDC_RSC_MGR 1
#ifdef OPLUS_ARCH_EXTENDS
/*Suresh.Alla@MULTIMEDIA.AUDIODRIVER.CODEC, 2020/07/31, Add for tfa98xx codec*/
#define CONFIG_SND_SOC_TFA9874 1
/*Suresh.Alla@MULTIMEDIA.AUDIODRIVER.CODEC, 2020/07/31, Add for speaker mute*/
#define OPLUS_FEATURE_SPEAKER_MUTE 1
/*Suresh.Alla@MULTIMEDIA.AUDIODRIVER.CODEC, 2020/07/31, Add for tfa vi feedback */
#define OPLUS_FEATURE_TFA98XX_VI_FEEDBACK 1
/*Suresh.Alla@MULTIMEDIA.AUDIODRIVER.ASOC, 2020/07/31, Add for 7125 plaftorm asoc macro */
#define OPLUS_FEATURE_PLATFORM_ATOLL 1
#endif /* OPLUS_ARCH_EXTENDS */

//#ifdef OPLUS_ARCH_EXTENDS
/*Guian.Chen@MULTIMEDIA.AUDIODRIVER.CODEC, 2020/07/31, Add for aw882xx codec*/
#define CONFIG_SND_SOC_AW882XX 1
//#endif /* OPLUS_ARCH_EXTENDS */

//#ifdef OPLUS_ARCH_EXTENDS
/*Kaiqin.Huang@RM.MM.AudioDriver.Codec, 2020/08/04, Add for sia81xx codec*/
