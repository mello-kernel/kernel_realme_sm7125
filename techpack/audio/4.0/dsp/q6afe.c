...
/* Juqiang.Geng@MULTIMEDIA.AUDIODRIVER.KERNEL, 2020/11/16,
 * Add for afe port id 0x1004 occurs error -131 feedback */
...
#ifdef OPLUS_ARCH_EXTENDS
/*Juqiang.Geng@MULTIMEDIA.AUDIODRIVER.KERNEL, 2020/11/13, Add for afe_callback wake_up issue*/
